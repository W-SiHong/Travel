    ...
    <div class="layui-header my-header">
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item"><%
					...
					%>
                <a class="name" href="javascript:;"><img src="./frame/static/image/code.png" alt="logo">你好，总经理<%=user.getRealname()%></a>
                <dl class="layui-nav-child"> 
...
layui.use(['layer','vip_nav'], function () {
    ...
    vipNav.top_left('json/nav_top_left4.json','side-top-left',false);
    // 主体菜单生成 [请求地址,过滤ID,是否展开,携带参数]
    vipNav.main('json/nav_main4.json','side-main',true);
