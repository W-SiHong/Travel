...
<body>
	...
	%>
	<blockquote class="layui-elem-quote">Tips:请认真核对出差总结,并填写相关报销表单</blockquote>
		...
		<table id="table1">
			...
			<tbody>
				<tr>
					...
					<td><%=s.getStatus()%></td>
					<td><a href="CheackSumServlet?sno=<%=s.getSno()%>">
							<button class="btn btn-info btn-mini">查看</button>
					</a>
					<td><a href="DeleteSummaryServlet?sno=<%=s.getSno()%>">
