...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        <a href="login.jsp">
           <img class="my-header-logo" src="frame/layui/images/face/logo.jpg" alt="logo">
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item"><%
					...
					%> 
                <a class="name" href="javascript:;"><img src="frame/static/image/code.png" alt="logo">你好，成本控制员：<%=user.getRealname()%> </a>
                <dl class="layui-nav-child">
                    
                    <dd><a href="login.jsp"><i class="layui-icon">&#x1006;</i>退出登录</a></dd>
                </dl>
            </li>
        </ul>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
               <li class="layui-nav-item  layui-nav-itemed">
                    <a href="javascript:;"><i class="layui-icon">&#xe620;</i>功能</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="demo/form.jsp"><i class="layui-icon">&#xe621;</i>表单1</a></dd>
                        <dd><a href="javascript:;" href-url="demo/form2.jsp"><i class="layui-icon">&#xe621;</i>表单2</a></dd>
                        <dd><a href="javascript:;" href-url="demo/form3.jsp"><i class="layui-icon">&#xe621;</i>表单3</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="demo/login.html"><i class="layui-icon">&#xe621;</i>登录</a></dd>
                     <!--    <dd><a href="javascript:;" href-url="demo/register.html"><i class="layui-icon">&#xe621;</i>注册页</a></dd>
                        ...
                        <dd><a href="javascript:;" href-url="demo/data-table.html"><i class="layui-icon">&#xe621;</i>员工表单审批 表格</a></dd>
...
layui.use(['layer','vip_nav'], function () {
    ...
    vipNav.top_left('json/nav_top_left3.json','side-top-left',false);
    // 主体菜单生成 [请求地址,过滤ID,是否展开,携带参数]
    vipNav.main('json/nav_main3.json','side-main',true);
