...
<body>
	<%
		List<TravelList> list1 = (List<TravelList>) request.getAttribute("applicationpass");
	%>
	<blockquote class="layui-elem-quote">Tips:请及时查看出差申请表单审核状态，出差完毕并填写总结表</blockquote>
		...
		<table id="table1">
			...
			<tbody>
				<tr>
					...
					<td><%=t.getStatus()%></td>
					<td><a href="travel_summary.jsp?tno=<%=t.getTno()%>">
							<button class="btn btn-info btn-mini">填写总结表</button>
					</a></td>
				</tr>
			</tbody>
			<%
