...
<body>
	<%
		List<Summary> list = (List<Summary>) request.getAttribute("examinesummary");
	%>
	<div class="row-fluid">
		<!-- block -->
		<div class="block">
					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tbody>
							<tr class="odd gradeX">
								...
								<td class="center"><a
									href="SummaryDetailServlet?sno=<%=s.getSno()%>"><button
											type="button" class="btn btn-info btn-mini">查看详细信息</button></a></td>
						</tbody>
						<%
							}
						%>
